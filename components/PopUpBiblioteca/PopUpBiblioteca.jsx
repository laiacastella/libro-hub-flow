...
const PopUpBiblioteca = ({ isOpen, onClose, intercambio, avanzarEstado }) => {
  ...
  // ya tengo el id
  console.log("intercambio id", libroSeleccionado);
  console.log("info libro", infoLibro);
    ...
    <div className={styles.overlay} onClick={onClose}>
      ...
      >
        ...
        <section className={styles.infoIntercambio}>
          ...
          <p>
            El intercambio se completará cuando el libro sea seleccionado y
            aceptes el intercambio.
          </p>
        </section>
