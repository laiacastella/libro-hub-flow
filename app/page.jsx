        ...
        <main className={styles.main}>
            ...
            <div className={styles.contenedorInfo}>
                ...
                <div className={styles.contenedorCards}>
                    <CardIcono rutaIcono="/square-plus.svg" texto="Añade facilmente los libros que quieres intercambiar" />

                    <CardIcono rutaIcono="/books.svg" texto="Explora miles de ejemplares de otros usuarios y solicita los que te interesen con un solo clic" />

                    <CardIcono rutaIcono="/truck-delivery.svg" texto="Una vez aceptado el intercambio , coordina el envio con el otro usuario" />

                    <CardIcono rutaIcono="/mood-check.svg" texto="Intercambiaste, leíste... ¡Ahora inspira! ¿Lo prestas o lo recomiendas?" />
                </div>
                ...
                <div className={styles.contenedorCards}>
                    <CardIcono rutaIcono="/world-share.svg" titulo="Comparte y Descubre" texto="Tu próxima lectura te está esperando gratis. Conecta estanterías de todo el país y accede a miles de títulos sin barreras." />
                    <CardIcono rutaIcono="/messages.svg" titulo="Conecta y Debate" texto="Mucho más que un intercambio. Entra en el foro, comparte tus teorías y encuentra a lectores que vibran con tus mismos autores." />
