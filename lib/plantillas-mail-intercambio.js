...
export async function enviarEmailIntercambioAceptado(idIntercambio) {
    try {
        ...
        console.log("Email de aceptación enviado a:", email_solicitante);
    } catch (e) {
...
export async function enviarEmailIntercambioRechazado(idIntercambio) {
    try {
        ...
        console.log("Email de rechazo enviado a:", email_solicitante);
    } catch (e) {
...
export async function enviarEmailIntercambioCompletado(idIntercambio) {
    try {
        ...
        console.log("Emails de intercambio completado enviados");
    } catch (e) {
...
export async function enviarEmailRecordatorioConfirmar(idIntercambio, idUsuarioDestino) {
    try {
        ...
        if (estadoUsuario !== "aceptado") {
            console.log("El usuario ya confirmó o el intercambio está en otro estado");
            return;
        }
        ...
        console.log("Email de recordatorio enviado a:", emailUsuario);
    } catch (e) {
...
export async function enviarEmailNuevaValoracion(idValoracion) {
    try {
        ...
        console.log("Email de nueva valoración enviado a:", email_evaluado);
    } catch (e) {
